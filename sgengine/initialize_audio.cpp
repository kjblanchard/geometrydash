...
FMOD::Studio::System* destroy()
{
    ...
    result = system->loadBankFile("../../sgengine/sfx/Master.bank", FMOD_STUDIO_LOAD_BANK_NORMAL, &mainBank);
    FMOD::Studio::Bank* stringsBank = nullptr;
    result = system->loadBankFile("../../sgengine/sfx/Master.strings.bank", FMOD_STUDIO_LOAD_BANK_NORMAL, &mainBank);
